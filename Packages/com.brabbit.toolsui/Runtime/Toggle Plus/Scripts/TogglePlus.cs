...
namespace UnityEngine.UI {
    ...
    /// </remarks>
    [AddComponentMenu("UI/Tools UI/Toggle Plus", 2)]
    [RequireComponent(typeof(RectTransform))]
    public class TogglePlus : Selectable, IPointerClickHandler, ISubmitHandler, ICanvasElement {
        /// <summary>
        ...
        private void SetToggleGroup(ToggleGroupPlus newGroup, bool setMemberValue) {
